...
<div class="accordion" id="accordionExample">
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <strong><li>NOTFIS 3.1</li></strong> - Cliente de Exemplo: <a href=<?php echo $notfisInt;?> target="_blank"> RIACHUELO</a><br> - Arquivo de Exemplo: <a href="/assets/Downloads/NOTFIS31.TXT"> DOWNLOAD</a> <hr>
      <strong><li>NOTFIS 5.0</li></strong> - Cliente de Exemplo: <a href=<?php echo $notfis5;?> target="_blank"> MERCUR</a><br>- Arquivo de Exemplo: <a href=> DOWNLOAD</a>
    </div>
    </div>
  </div>
  <div class="accordion-item">
